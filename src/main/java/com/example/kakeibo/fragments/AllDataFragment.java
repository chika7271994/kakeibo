...
public class AllDataFragment extends BaseFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //yy = new SimpleDateFormat("yyyy", Locale.getDefault()).format(new Date(month));
        //mm = new SimpleDateFormat("MM", Locale.getDefault()).format(new Date(month));
        LogUtil.debug("AlldataFragment", "日付は"+ month);
        LogUtil.debug("AlldataFragment", "日付は"+ yy);
        LogUtil.debug("AlldataFragment", "日付は"+ mm);
